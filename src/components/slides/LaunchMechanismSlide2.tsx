...
import xDriveQuadHeadDesign from "../../assets/X-Drive Quad Head Design.png";

interface Props {
  totalSlides: number;
}

export const LaunchMechanismSlide2 = ({ totalSlides }: Props) => {
  const conceptPoints = [
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <ImagePlaceholder 
            ...
            aspectRatio="square"
            src={xDriveQuadHeadDesign}
            alt="X-Drive Quad Head Design - 4 motors in X-configuration with ball grip points"
          />
        </div>
      </div>
    </SlideLayout>
